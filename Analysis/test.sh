...
do
    ...
    python $PATHPACMAN/capture.py -r $PATHPACMAN/$RED.py -b $PATHPACMAN/$BLUE.py -l $PATHPACMAN/layouts/$var -q --delay-step=0.001 | tee -a output.log
    echo "= = = = = = = = = = = = = = = =" >> output.log
done
for var in 6311 2608 4331 6146 5702 4636 4417 8278 1160 7633 8951 4469 2746 5193 128 3914 5732 6395 7953 6937 5018 5756 9274 2482 1279 1498 2110 3022 6592 9440 5686 1006 4921 7673 2963 455 5778 2425 5951 3100 8029 141 3633 8874 7748 2159 598 7045 3510 1155 9359 9577 5997 3796 6316 7693 507 1708 362 1928 288 2062 8301 9058 2700 8022 9317 668 6989 4753 4280 2708 6119 1337 7379 46 5589 3946 5823 6263 9802 4574 37 1621 3622 1224 3280 9013 9809 7064 5630 4169 6246 5784 2436 8155 1160 58 100 9825
do
    MAP='RANDOM'
    echo $MAP$var >> output.log
    echo $RED >> output.log
    ...
    python $PATHPACMAN/capture.py -r $PATHPACMAN/$RED.py -b $PATHPACMAN/$BLUE.py -l $MAP$var -q --delay-step=0.001 | tee -a output.log
    echo "= = = = = = = = = = = = = = = =" >> output.log
done
#############################################################
# To run the file, specify parameters
# Navigate to the shell file directory and run by: ./test.sh
# Fixed layout:
